...
export function ContactSection() {
  ...
  const validateForm = () => {
    ...
    if (!formData.projectType) errors.projectType = "Please select a Service Interest";
  ...
  const projectTypes = ["Shopify Development", "AI Automation", "Full Stack Development", "App Development", "SEO & Marketing", "CRO & A/B Testing"];
  ...
  return (
    <section className="relative w-full bg-[#0b0c10] py-20 lg:py-28 overflow-hidden border-b border-white/5">
      ...
      <div className="relative z-10 w-full max-w-[1280px] mx-auto px-4 md:px-10 grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left gap-5 lg:gap-10 lg:sticky lg:top-[40px]">
          ...
          <div className="flex flex-col gap-10 mt-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <span className="text-lg sm:text-[20px] font-normal text-white font-[family-name:var(--font-inter)]">
                510 Shivam Arcade, 2, Naroda - Dehgam Rd, opp. Naroda business hub, Vasant Vihar 2, Nava Naroda, Ahmedabad, Gujarat 382330
              </span>
            </div>
        ...
        <div className="lg:col-span-5 w-full ps-8 pe-8 sm:p-10 pt-0 pb-0 group/form">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            ...
            {/* Field 3: Service Interest (Pills) */}
            ...
            <div className="flex flex-col gap-3 relative">
              ...
              <div className="relative">
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full bg-transparent border-b border-white/10 py-3 text-lg font-normal text-white focus:border-[#9390f9] focus:outline-none transition-colors duration-200 font-[family-name:var(--font-inter)] appearance-none cursor-pointer pr-10"
                >
                  <option value="" disabled className="bg-[#0b0c10] text-[#bbb2b2]/40">
                    Select budget range
                  </option>
                  <option value="under $5000" className="bg-[#0b0c10] text-white">
                    under $5000
                  </option>
                  <option value="$5000 - $15000" className="bg-[#0b0c10] text-white">
                    $5000 - $15000
                  </option>
                  <option value="$15000 - $50000" className="bg-[#0b0c10] text-white">
                    $15000 - $50000
                  </option>
                  <option value="$50000+" className="bg-[#0b0c10] text-white">
                    $50000+
                  </option>
                  <option value="Not Sure Yet" className="bg-[#0b0c10] text-white">
                    Not Sure Yet
                  </option>
                </select>
                <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2 text-[#bbb2b2]">
                  <svg
                    className="h-5 w-5"
                    fill="none"
                    viewBox="0 0 24 24"
      ...
      <section className="relative w-full min-h-[567px] flex items-center justify-center overflow-hidden px-6 lg:px-[60px] py-16 md:py-24 bg-[#0b0c10] border-b border-white/5">
        ...
        <div className="relative z-10 w-full max-w-[1280px] mx-auto text-center flex flex-col items-center">
          ...
          <p className="text-lg sm:text-[22px] lg:text-2xl text-[#bbb2b2] leading-relaxed max-w-[1030px] font-[family-name:var(--font-inter)] font-normal">
            We’re here to help. Reach out to us and let’s start building something great together.
          </p>
        </div>
      </section>
        ...
        <div className="relative z-10 w-full max-w-[859px] mx-auto text-center flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-base sm:text-lg text-[#bbb2b2] font-light font-[family-name:var(--font-inter)] tracking-wide max-w-[650px] leading-relaxed mx-auto">
              Whether you have a project in mind, need a consultation, or just want to explore possibilities — we&apos;d love to hear from you.
            </p>
          </div>

          {/* Premium Call Button (Frame 839) */}
          <a
            href="tel:+9170469 41095"
